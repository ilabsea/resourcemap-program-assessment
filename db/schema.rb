...
ActiveRecord::Schema.define() do
  ...
  add_index "report_cachings", ["collection_id", "report_query_id"], name: "index_report_cachings_on_collection_id_and_report_query_id", unique: true, using: :btree
  ...
  add_index "report_queries", ["collection_id"], name: "index_report_queries_on_collection_id", using: :btree
  ...
  add_index "report_query_templates", ["collection_id"], name: "index_report_query_templates_on_collection_id", using: :btree
  add_index "report_query_templates", ["report_query_id"], name: "index_report_query_templates_on_report_query_id", using: :btree
  ...
  create_table "site_histories", force: true do |t|
    ...
    t.string   "uuid"
    t.integer  "user_id"
    t.datetime "start_entry_date",                                     default: '2018-07-12 00:38:04'
    t.datetime "end_entry_date",                                       default: '2018-07-12 00:38:04'
  end
